...
namespace ParkingZoneApp.Data.Migrations
{
    ...
    [Migration("20240509110204_ReservationUserIdEdited")]
    partial class ReservationUserIdEdited
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkingZoneApp.Models.Reservation", b =>
                {
                    b.HasOne("ParkingZoneApp.Models.ParkingSlot", "ParkingSlot")
                        .WithMany("Reservations")
                        .HasForeignKey("ParkingSlotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ParkingZoneApp.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
